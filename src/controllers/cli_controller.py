...
def seed_db():
    ...
    areas = [
        Area(
            ...
            year old quartzite, that is coarse and may contain sharp crystals, be mindful of skin care. Features 
            challenging mantle topouts with many slopers. Most landings are flat and easily protected.""",
            ethics = """Local urban nature preserve, a common are of walkers and cyclists, dogs are also allowed on leash.
            Be courteous to other groups, keep noise to a minimum, do not climbed damaged or chipped routes and clean up
            your rubbish. Please also clean chalk and marks on boulders and stick to the given trails if available""",
            access = """Entry to northern area via the car park at Tooheys Picnic Area on google maps, located on Toohey Rd. 
            Lat & Long provided are those of the Picnic Area Main Car Park. Trails provide entry to most sectors which have
            relatively flat approaches and easy access.""",
            latitude = 27.53691,
            longitude = 153.04170,
            created = date.today()            
        ),
        Area(
            ...
            ethics = """Located within a National Park, please minimise impact to the nature and wildlife, clean up rubbish,
            remove chalk marks and respect the area. Please refer to signs located in the park for more info.""",
            access = """Drive out of Queanbeyan towards Bungendore on the Kings Highway and take a right onto Captain's Flat Road. 
            After driving for a while (about 13.5km) turn left onto Briars Sharrow Road (be careful to not miss this). 
            Cross the creek and continue a short distance, taking the next right. Drive to the end of this road and at the T-intersection
            turn right, to Hoskinstown. Drive through the town and take a left onto a dirt road (Forbes Creek Road). The dirt road 
            continues for some 10km through fairly rough terrain - continue on until you reach a small parking area. 
            Back up the road some five metres and to the right is The Hill, and on the left are the remainder of the areas.
